  ...
  return (
    <div className=" d-flex justify-content-center flex-column bgs " id="pics">
      {/* <div className="mt-5 p-4 ms-5">
        <NavLink to="/redulist" className="">
          <Button className="btn btn-dark ms-5 mt-5 p-2 btn-grad1">Back</Button>
        </NavLink>{" "}
      </div> */}
 <div className=" d-flex justify-content-start mt-3 ms-3 pb-3">
        <Link to="/redulist">
      ...
      <div className="container col-md-8 card shadow mb-5 pt-3" id="cove">
          ...
          <span className="shadow-sm   bg-dark text-light  bg-opacity-75 rounded p-1">Reducer Form</span>{" "}
            </h1>
